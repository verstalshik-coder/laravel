...
let swiper1 = document.querySelector(".swiper-container");
let id = swiper1.querySelector(".swiper-slide-active").id;
let bg = document.querySelector(".screen2").querySelector(".content");
let head = bg.querySelector(".slider-content-head");
let paragraph = bg.querySelector(".slider-content-paragraph");

chngebg(id);

window.setInterval( function() {
    let temp = swiper1.querySelector(".swiper-slide-active").id;
    if(temp !== id) {
        chngebg(temp);
        id = temp;
    }
